...
<body>
  ...
  <header id="header" class="fixed-top ">
    ...
    <div class="search-bar">
      <form class="search-form d-flex align-items-center" method="GET" action="./User/search_user.php">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="./User/tkkd_index.php">Thuốc không kê đơn</a></li>
          <li><a class="nav-link scrollto" href="./User/hmp_index.php">Hóa mỹ phẩm</a></li>
          <li><a class="nav-link scrollto" href="./User/tpcn_index.php">Thực phẩm chức năng</a></li>
          ...
          ?>
            ...
            <li>
                <a class=" scrollto" href="./cart/cart.php">
