...
<!-- START ADD products -->
<li class="nav-item">
  <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="add-pd.php">
    <i class="bi bi-menu-button-wide"></i><span>Add Product</span>
  </a>
</li><!-- End Forms Nav -->
<!-- START ADD category -->
<li class="nav-item">
  <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="add_cate.php">
    <i class="bi bi-menu-button-wide"></i><span>Add Category</span>
  </a>
</li><!-- End Forms Nav -->
<!-- START UPDATE -->
<li class="nav-item">
  <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="update-pd.php">
    <i class="bi bi-journal-text"></i><span>Update Product</span>
  </a>
</li><!-- End Forms Nav -->
<!-- Dữ liệu -->
<li class="nav-item">
  <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="data.php">
